...
private:
    ...
    juce::SmoothedValue<float> delaySmoothed, feedbackSmoothed, saturationSmoothed, mixSmoothed;
    std::vector<float> delayBuffer, feedbackBuffer, saturationBuffer, mixBuffer;
